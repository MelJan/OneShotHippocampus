...
zca = PRE.PCA(data.shape[1], False)
zca.train(data)
data = zca.unproject(zca.project(data, 800))
...
P = v41 * v42
Q = v51 * v52
cons1 = None#Weight_layer.generate_2D_connection_matrix(v11, v12, 8, 8, 7, 7, False)
#cons1 = numx.vstack((numx.hstack((cons1,cons1)).T,numx.hstack((cons1,cons1)).T)).T
cons2 = None#Weight_layer.generate_2D_connection_matrix(v21, v22, 8, 8, 7, 7, False)
#cons2 = numx.vstack((numx.hstack((cons2,cons2)).T,numx.hstack((cons2,cons2)).T)).T
cons3 = None#Weight_layer.generate_2D_connection_matrix(v31, v32, 8, 8, 7, 7, False)

cons4 = None#Weight_layer.generate_2D_connection_matrix(v41, v42, 8, 8, 7, 7, False)
...
lr_W = numx.array([1.0,1.0,1.0,1.0])*0.01

lr_b =  numx.array([0.0,1.0,1.0,1.0,1.0])*0.01

lr_o =  numx.array([0.0,1.0,1.0,1.0,1.0])*0.01
...
for epoch in range(0,max_epochs) :
    ...
    print '\t' 
    for i in range(num_layers): 
        print numx.mean(pos_chains[i]),'\t',
    print '\t' 
    for i in range(num_layers): 
        print numx.mean(neg_chains[i]),'\t',
    print " "
...
VIS.imshow_matrix(VIS.tile_matrix_rows(layers[0].activation(None,pos_chains[1])[0][0:batch_size].T, v11,v12, batch_size/10,10, border_size = 1,normalized = False), 'sample 1p backproj')
VIS.imshow_matrix(VIS.tile_matrix_rows(pos_chains[1][0:batch_size].T, v21,v22, batch_size/10,10, border_size = 1,normalized = False), 'sample 2p')
VIS.imshow_matrix(VIS.tile_matrix_rows(pos_chains[2][0:batch_size].T, v31,v32, batch_size/10,10, border_size = 1,normalized = False), 'sample 3p')
VIS.imshow_matrix(VIS.tile_matrix_rows(pos_chains[3][0:batch_size].T, v41,v42, batch_size/10,10, border_size = 1,normalized = False), 'sample 4p')
VIS.imshow_matrix(VIS.tile_matrix_rows(pos_chains[4][0:batch_size].T, v51,v52, batch_size/10,10, border_size = 1,normalized = False), 'sample 5p')

VIS.imshow_matrix(VIS.tile_matrix_rows(neg_chains[0][0:batch_size].T, v11,v12, batch_size/10,10, border_size = 1,normalized = False), 'sample 1n') 
VIS.imshow_matrix(VIS.tile_matrix_rows(layers[0].activation(None,neg_chains[1])[0][0:batch_size].T, v11,v12, batch_size/10,10, border_size = 1,normalized = False), 'sample 1n backproj')
...
VIS.imshow_matrix(VIS.tile_matrix_rows(neg_chains[2][0:batch_size].T, v31,v32, batch_size/10,10, border_size = 1,normalized = False), 'sample 3n')
VIS.imshow_matrix(VIS.tile_matrix_rows(neg_chains[3][0:batch_size].T, v41,v42, batch_size/10,10, border_size = 1,normalized = False), 'sample 4n')
VIS.imshow_matrix(VIS.tile_matrix_rows(neg_chains[4][0:batch_size].T, v51,v52, batch_size/10,10, border_size = 1,normalized = False), 'sample 5n')

VIS.imshow_matrix(VIS.tile_matrix_rows(layers[0].output_weight_layer.weights, 32,32, v21,v22, border_size = 1,normalized = False), 'Weights 1')
VIS.imshow_matrix(VIS.tile_matrix_rows(numx.dot(layers[0].output_weight_layer.weights,layers[1].output_weight_layer.weights), 32,32, v31,v32, border_size = 1,normalized = False), 'Weights 2')
VIS.imshow_matrix(VIS.tile_matrix_rows(numx.dot(layers[0].output_weight_layer.weights,numx.dot(layers[1].output_weight_layer.weights,layers[2].output_weight_layer.weights)), 32,32, v41,v42, border_size = 1,normalized = False), 'Weights 3')
VIS.imshow_matrix(VIS.tile_matrix_rows(numx.dot(layers[0].output_weight_layer.weights,numx.dot(layers[1].output_weight_layer.weights,numx.dot(layers[2].output_weight_layer.weights,layers[3].output_weight_layer.weights))), 32,32, v51,v52, border_size = 1,normalized = False), 'Weights 4')
...
# Show weights
VIS.imshow_matrix(VIS.tile_matrix_rows(zca.unproject(layers[0].output_weight_layer.weights), 32,32, v21,v22, border_size = 1,normalized = False), 'Weights 1')
VIS.imshow_matrix(VIS.tile_matrix_rows(zca.unproject(numx.dot(layers[0].output_weight_layer.weights,layers[1].output_weight_layer.weights)), 32,32, v31,v32, border_size = 1,normalized = False), 'Weights 2')
VIS.imshow_matrix(VIS.tile_matrix_rows(zca.unproject(numx.dot(layers[0].output_weight_layer.weights,numx.dot(layers[1].output_weight_layer.weights,layers[2].output_weight_layer.weights))), 32,32, v41,v42, border_size = 1,normalized = False), 'Weights 3')
VIS.imshow_matrix(VIS.tile_matrix_rows(zca.unproject(numx.dot(layers[0].output_weight_layer.weights,numx.dot(layers[1].output_weight_layer.weights,numx.dot(layers[2].output_weight_layer.weights,layers[3].output_weight_layer.weights)))), 32,32, v41,v42, border_size = 1,normalized = False), 'Weights 4')
