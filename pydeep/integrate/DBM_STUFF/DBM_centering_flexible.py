...
for epoch in range(0,max_epochs) :
    for b in range(0,data.shape[0],batch_size):
        ...
        for _ in range(k_pos):
            y_d = l2.activation(x_d, z_d, l1.offset, l3.offset)
            y_d = l2.sample(y_d)
            z_d = l3.activation(y_d, None, l2.offset, None)
            z_d = l3.sample(z_d)
        ...
        grad_b2 =l2.calculate_gradient_b(y_d, y_m)
        grad_b3 =l3.calculate_gradient_b(z_d, z_m)
