...
Z_AIS_rev = ESTIMATOR.reverse_annealed_importance_sampling(rbm, num_chains=100, k=1, betas=1000, status=False)[0]

# Calculate and print LL
print ""
print "\n True Partition: ", Z," (True         LL: ",
print numx.mean(ESTIMATOR.log_likelihood_v(rbm, Z , data)), ")"
print " AIS  Partition: ", Z_AIS," (~Upper bound LL: ",
print numx.mean(ESTIMATOR.log_likelihood_v(rbm, Z_AIS , data)), ")"
print "rAIS  Partition: ", Z_AIS_rev," (~Lower bound LL: ",
print numx.mean(ESTIMATOR.log_likelihood_v(rbm, Z_AIS_rev , data)), ")"
