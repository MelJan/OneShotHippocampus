...
Z_AIS_rev = ESTIMATOR.reverse_annealed_importance_sampling(rbm, status= False, data = train_data)[0]
...
print numx.mean(ESTIMATOR.log_likelihood_v(rbm, Z_AIS , train_data)), ")"
print "rAIS  Partition: ", Z_AIS_rev," (~Lower bound LL: ",
print numx.mean(ESTIMATOR.log_likelihood_v(rbm, Z_AIS_rev , train_data)), ")"
